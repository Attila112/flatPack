...
import SentImg from "../../images/Animation - 1732176708730.gif"
function ContactUs(props) {
    ...
    async function handleSubmit  (e){
        e.preventDefault()
        const infoMail = {name: name, email: email, message: message}

        const response = await fetch("http://127.0.0.1:8000/api/infomail", {
          method: "POST",
        ...
        <div className="font-[sans-serif] max-w-6xl max-lg:max-w-3xl mx-auto p-4">
            <div className="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded p-8">
                ...
                <div className="grid lg:grid-cols-2 items-start gap-12">
                    {sent ? (<div className="flex items-center justify-center "> <img src={SentImg}/> <h2> Thanks for your message!</h2></div>) : (
                    <form className="space-y-3 text-gray-800" onSubmit={handleSubmit}>
                        ...
                        <input type='email' placeholder='Email' name={"email"} onChange={handleChange} required
                               className="w-full bg-gray-100 rounded py-3 px-6 text-sm focus:bg-transparent focus:outline-blue-600"/>
                        <textarea placeholder='Message' rows="6" name={"message"} onChange={handleChange} required
                    ...
                    <div className="grid sm:grid-cols-2  gap-12">
                        <div className="flex items-start bg-white">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-sm text-gray-500 mt-1"> 123 Main Street, City, Country</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start bg-white">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-sm text-gray-500 mt-1"> +36 12 345 6789</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start bg-white">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="text-sm text-gray-500 mt-1">info@flatpack.com</p>
                            </div>
                        </div>
                    </div>
                </div>
